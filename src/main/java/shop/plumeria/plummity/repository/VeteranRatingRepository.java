...
public interface VeteranRatingRepository extends JpaRepository<VeteranRatingDAO, String> {
    @Query("select dao.type from VeteranRatingDAO dao where dao.user.useridentifier like :useridentifier and dao.image.uuid like :imageId")
    VeteranRatingType getTypeIfExists(String useridentifier, String imageId);
